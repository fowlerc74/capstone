...
# This sets up all the arrays that will be used in making the line graph
def setup_plot(pred, sel_col):
    i = 0
    # Holds the dates that are currently being used for prediction
    date_arr = []
    # Selects the user-selected column and prediction from the prediction DataFrame
    ...
    # Count the number of days for the date array
...
def setup_line_graph(pred_arr, sel_col_arr, date_arr, sel_col):
    ...
    # Make the first blue line the actual daily precipitation values
